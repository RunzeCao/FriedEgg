package com.example.friedegg.view;
...
public class AutoLoadRecyclerView extends RecyclerView implements LoadFinishCallBack {
    ...
    public void setOnPauseListenerParams(boolean pauseOnScroll, boolean pauseOnFling) {
        // TODO: 2016/5/25
        addOnScrollListener(new AutoLoadScrollListener(null, pauseOnScroll, pauseOnFling));
    }
    ...
    private class AutoLoadScrollListener extends OnScrollListener {
        ...
        private AutoLoadScrollListener(ImageLoader imageLoader, boolean pauseOnScroll, boolean pauseOnFling) {
            super();
